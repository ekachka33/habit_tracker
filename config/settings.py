...
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'habits.pagination.HabitPagination', # <--- Изменение здесь
    'PAGE_SIZE': 5,

    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',
        'rest_framework.authentication.SessionAuthentication', # <--- Добавил
        'rest_framework.authentication.BasicAuthentication',   # <--- Добавил
    ),
